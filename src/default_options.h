 ...
 * Homedir is prepended if path begins with etc/dropbear/
 */
...
/* etc/dropbear/.ssh/authorized_keys authentication.
 ...
 * Homedir is prepended if path begins with etc/dropbear/
 */
#define DROPBEAR_DEFAULT_CLI_AUTHKEY "etc/dropbear/.ssh/id_dropbear"
